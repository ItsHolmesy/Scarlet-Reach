/datum/advclass/ogre/avatar
	...
	traits_applied = list(TRAIT_STRENGTH_UNCAPPED, TRAIT_CRITICAL_RESISTANCE, TRAIT_NOPAINSTUN, TRAIT_CALTROPIMMUNE, TRAIT_STRONGBITE, TRAIT_MEDIUMARMOR, TRAIT_AVATAR_GRAGGAR) //strongbite might be funny
	subclass_stats = list( 
		STATKEY_STR = 4, 
		STATKEY_CON = 6,
		STATKEY_END = 5,
